...
curl -f -X POST https://api.github.com/repos/$USERNAME/$REPO/labels -H "Authorization: token $GH_TOKEN" -d '{"version:name":"patch","description":"Geringfügige Korrektur ohne Risiko","color":"FBCA04"}'
